...
const ComputerVisionClient = require('../../../lib/services/computerVision/lib/ComputerVisionClient');
const fs = require('fs');
...
describe('Computer Vision', () => {
  before(function (done) {
    ...
    suite.setupSuite(() => {
      ...
      client = new ComputerVisionClient(credentials, "https://westus.api.cognitive.microsoft.com");
      done();
    });
  });
